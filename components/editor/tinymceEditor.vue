...
export default {
    ...
    props: {
      ...
      plugins: {
        type: [String, Array],
        default: 'code,lists,advlist,image,autoresize,codesample,link,hr,fullscreen,quickbars,paste'
      },
      toolbar: {
        type: [String, Array],
        default: 'undo redo  | h2Title blockquote imagelibrary hr bold italic forecolor backcolor  | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent  | removeformat'
      }
    },
    data(){
        return{
